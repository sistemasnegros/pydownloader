...
class GenericConfig(object):
    """method for prepare app"""

    def __init__(self, load_config, name_file_config_path, name_file_log_path, name_file_csv_path):
        self.name_file_config_path = name_file_config_path
        self.name_file_log_path = name_file_log_path
        self.name_file_csv_path = name_file_csv_path
        self.args = ""
        self.config = ""
    ...
    def loading_args(self):
        ...
        parser.add_argument("-csv", "--csv", help="Nombre de archivo de csv.", default=self.name_file_csv_path)
